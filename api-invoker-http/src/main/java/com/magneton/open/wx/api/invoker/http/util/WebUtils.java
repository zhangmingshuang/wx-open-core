package com.magneton.open.wx.api.invoker.http.util;
...
public abstract class WebUtils {
    ...
    public static String doPost(String url, Map<String, String> params, int connectTimeout,
        ...
        return doPost(url, ctype, content, connectTimeout, readTimeout, headers);
    }
    ...
    private static HttpURLConnection getConnection(URL url, String method,
        ...
        conn.setRequestProperty("Accept", "text/xml,text/javascript,text/html,text/json,application/json");
